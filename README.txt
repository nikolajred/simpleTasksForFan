...
Дана последовательность действительных чисел а1, а2, ... an. Выяснить будет ли она возростающей

Простая задача №8

Написать метод который инвертирует массив

Простая задача №9

В целочисленной последовательности есть нуливые элементы. Создать массив из нумеров этих элементов